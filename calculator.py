...
#things needed ti be imported in order to create a GUI
from tkinter import *
...
class Calculator:
    ...
    def __init__(self, root):
        ...
        self.button_div = ttk.Button(root,text="/", command=lambda: self.button_press('/')).grid(row=1,column=3)
        #---------2nd Row-----------
        ...
        self.button_mult = ttk.Button(root,text="*", command=lambda: self.button_press('*')).grid(row=2,column=3)
        #---------3rd Row-----------
        ...
        self.button_add = ttk.Button(root,text="+", command=lambda: self.button_press('+')).grid(row=3,column=3)
        #---------4th Row-----------
        ...
        self.button_equal = ttk.Button(root,text="=", command=lambda: self.button_press('=')).grid(row=4,column=2)
        self.button_sub = ttk.Button(root,text="-", command=lambda: self.button_press('-')).grid(row=4,column=3)
